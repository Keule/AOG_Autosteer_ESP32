...
//The default I2C address for the BNO080 on the SparkX breakout is 0x4B. 0x4A is also possible.
	//-- moved to arduinoGlue.h // #define BNO080_DEFAULT_ADDRESS 0x4B
...
//I2C_BUFFER_LENGTH is defined in Wire.H
	//-- moved to arduinoGlue.h // #define I2C_BUFFER_LENGTH BUFFER_LENGTH

#else

//The catch-all default is 32
	//-- moved to arduinoGlue.h // #define I2C_BUFFER_LENGTH 32
...
//These are used for low level communication with the sensor, on channel 2
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_COMMAND_RESPONSE 0xF1
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_COMMAND_REQUEST 0xF2
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_FRS_READ_RESPONSE 0xF3
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_FRS_READ_REQUEST 0xF4
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_PRODUCT_ID_RESPONSE 0xF8
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_PRODUCT_ID_REQUEST 0xF9
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_BASE_TIMESTAMP 0xFB
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_SET_FEATURE_COMMAND 0xFD
	//-- moved to arduinoGlue.h // #define SHTP_REPORT_GET_FEATURE_RESPONSE 0xFC //Add by Math : Get Feature Response report

//All the different sensors and features we can get reports from
//These are used when enabling a given sensor
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_ACCELEROMETER 0x01
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_GYROSCOPE 0x02
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_MAGNETIC_FIELD 0x03
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_LINEAR_ACCELERATION 0x04
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_ROTATION_VECTOR 0x05
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_GRAVITY 0x06
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_GAME_ROTATION_VECTOR 0x08
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_GEOMAGNETIC_ROTATION_VECTOR 0x09
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_GYRO_INTEGRATED_ROTATION_VECTOR 0x2A
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_TAP_DETECTOR 0x10
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_STEP_COUNTER 0x11
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_STABILITY_CLASSIFIER 0x13
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_RAW_ACCELEROMETER 0x14
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_RAW_GYROSCOPE 0x15
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_RAW_MAGNETOMETER 0x16
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_PERSONAL_ACTIVITY_CLASSIFIER 0x1E
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_AR_VR_STABILIZED_ROTATION_VECTOR 0x28
	//-- moved to arduinoGlue.h // #define SENSOR_REPORTID_AR_VR_STABILIZED_GAME_ROTATION_VECTOR 0x29

//Record IDs from figure 29, page 29 reference manual
//These are used to read the metadata for each sensor type
	//-- moved to arduinoGlue.h // #define FRS_RECORDID_ACCELEROMETER 0xE302
	//-- moved to arduinoGlue.h // #define FRS_RECORDID_GYROSCOPE_CALIBRATED 0xE306
	//-- moved to arduinoGlue.h // #define FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED 0xE309
	//-- moved to arduinoGlue.h // #define FRS_RECORDID_ROTATION_VECTOR 0xE30B

//Command IDs from section 6.4, page 42
//These are used to calibrate, initialize, set orientation, tare etc the sensor
	//-- moved to arduinoGlue.h // #define COMMAND_ERRORS 1
	//-- moved to arduinoGlue.h // #define COMMAND_COUNTER 2
	//-- moved to arduinoGlue.h // #define COMMAND_TARE 3
	//-- moved to arduinoGlue.h // #define COMMAND_INITIALIZE 4
	//-- moved to arduinoGlue.h // #define COMMAND_DCD 6
	//-- moved to arduinoGlue.h // #define COMMAND_ME_CALIBRATE 7
	//-- moved to arduinoGlue.h // #define COMMAND_DCD_PERIOD_SAVE 9
	//-- moved to arduinoGlue.h // #define COMMAND_OSCILLATOR 10
	//-- moved to arduinoGlue.h // #define COMMAND_CLEAR_DCD 11

	//-- moved to arduinoGlue.h // #define CALIBRATE_ACCEL 0
	//-- moved to arduinoGlue.h // #define CALIBRATE_GYRO 1
	//-- moved to arduinoGlue.h // #define CALIBRATE_MAG 2
	//-- moved to arduinoGlue.h // #define CALIBRATE_PLANAR_ACCEL 3
	//-- moved to arduinoGlue.h // #define CALIBRATE_ACCEL_GYRO_MAG 4
	//-- moved to arduinoGlue.h // #define CALIBRATE_STOP 5

	//-- moved to arduinoGlue.h // #define MAX_PACKET_SIZE 128 //Packets can be up to 32k but we don't have that much RAM.
	//-- moved to arduinoGlue.h // #define MAX_METADATA_SIZE 9 //This is in words. There can be many but we mostly only care about the first 9 (Qs, range, etc)
