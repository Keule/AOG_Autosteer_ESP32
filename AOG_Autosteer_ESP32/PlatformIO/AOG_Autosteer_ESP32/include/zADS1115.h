...
//============ Added by Convertor ==========
	...
	//-- moved to arduinoGlue.h // 	#define ADS1115_ADDRESS_ADDR_GND    0x48 // address pin low (GND)
	//-- moved to arduinoGlue.h // 	#define ADS1115_ADDRESS_ADDR_VDD    0x49 // address pin high (VCC)
	//-- moved to arduinoGlue.h // 	#define ADS1115_ADDRESS_ADDR_SDA    0x4A // address pin tied to SDA pin
	//-- moved to arduinoGlue.h // 	#define ADS1115_ADDRESS_ADDR_SCL    0x4B // address pin tied to SCL pin
	//-- moved to arduinoGlue.h // 	#define ADS1115_DEFAULT_ADDRESS     ADS1115_ADDRESS_ADDR_GND
/*=========================================================================*/

/*=========================================================================
    POINTER REGISTERS
    -----------------------------------------------------------------------*/
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_POINTER_CONVERT     (0x00)
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_POINTER_CONFIG      (0x01)
/*=========================================================================*/

/*=========================================================================
    CONFIG REGISTER
    -----------------------------------------------------------------------*/
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_OS_SINGLE    (0x8000)  // Write: Set to start a single-conversion

	//Mux Parameters.  Used as input to setMux()
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_DIFF_0_1 (0x0000)  // Differential P = AIN0, N = AIN1 (default)
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_DIFF_0_3 (0x1000)  // Differential P = AIN0, N = AIN3
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_DIFF_1_3 (0x2000)  // Differential P = AIN1, N = AIN3
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_DIFF_2_3 (0x3000)  // Differential P = AIN2, N = AIN3
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_SINGLE_0 (0x4000)  // Single-ended AIN0
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_SINGLE_1 (0x5000)  // Single-ended AIN1
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_SINGLE_2 (0x6000)  // Single-ended AIN2
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MUX_SINGLE_3 (0x7000)  // Single-ended AIN3

	//Gain parameter.  Used as input to setGain()
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_PGA_6_144V   (0x0000)  // +/-6.144V range = Gain 2/3
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_PGA_4_096V   (0x0200)  // +/-4.096V range = Gain 1
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_PGA_2_048V   (0x0400)  // +/-2.048V range = Gain 2 (default)
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_PGA_1_024V   (0x0600)  // +/-1.024V range = Gain 4
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_PGA_0_512V   (0x0800)  // +/-0.512V range = Gain 8
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_PGA_0_256V   (0x0A00)  // +/-0.256V range = Gain 16
	...
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_MODE_SINGLE  (0x0100)  // Power-down single-shot mode (default)
	...
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_8SPS    (0x0000)  // 8 SPS(Sample per Second), or a sample every 125ms
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_16SPS    (0x0020)  // 16 SPS, or every 62.5ms
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_32SPS    (0x0040)  // 32 SPS, or every 31.3ms
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_64SPS    (0x0060)  // 64 SPS, or every 15.6ms
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_128SPS   (0x0080)  // 128 SPS, or every 7.8ms  (default)
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_250SPS   (0x00A0)  // 250 SPS, or every 4ms, note that noise free resolution is reduced to ~14.75-16bits, see table 2 in datasheet
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_475SPS   (0x00C0)  // 475 SPS, or every 2.1ms, note that noise free resolution is reduced to ~14.3-15.5bits, see table 2 in datasheet
	//-- moved to arduinoGlue.h //     #define ADS1115_REG_CONFIG_DR_860SPS   (0x00E0)  // 860 SPS, or every 1.16ms, note that noise free resolution is reduced to ~13.8-15bits, see table 2 in datasheet
