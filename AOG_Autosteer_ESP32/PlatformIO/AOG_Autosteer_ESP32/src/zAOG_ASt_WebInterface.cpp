...
#include "zAOG_ASt_WebInterface.h"
char HTML_String[40000];

	//-- moved to arduinoGlue.h // #define ACTION_LoadDefaultVal   1
	//-- moved to arduinoGlue.h // #define ACTION_RESTART          2
	//-- moved to arduinoGlue.h // #define ACTION_SET_WAS_ZERO     3
	//-- moved to arduinoGlue.h // #define ACTION_SET_INCL_ZERO    4
	//-- moved to arduinoGlue.h // #define ACTION_SET_WS_THRESHOLD 5
